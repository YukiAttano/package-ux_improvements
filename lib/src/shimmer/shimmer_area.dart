...
class ShimmerArea
  ...
  ShimmerArea.fromColors({
    ...
    Widget? child,
          ...
          gradient:
            ...
            stops: silverShimmerGradient
                .stops,
            begin: silverShimmerGradient
                .begin,
            end: silverShimmerGradient
                .end,
            tileMode:
                silverShimmerGradient.tileMode,
          ),
          duration:
              duration,
          child:
  ...
  static const silverShimmerGradient =
      LinearGradient(
    colors:
        sliverColors,
    stops: [
