abstract class ScreenshotBoundaryException
    implements
        Exception {
  final String
      message;

  const ScreenshotBoundaryException(
      this.message);
}
...
class ScreenshotBoundaryNoAncestorException
  ...
  const ScreenshotBoundaryNoAncestorException()
      : super(
            "No ScreenshotBoundary widget connected to the Controller");
}

class ScreenshotBoundaryNoImageException
    extends ScreenshotBoundaryException {
