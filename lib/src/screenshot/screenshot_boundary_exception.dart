...
class ScreenshotBoundaryNoImageException extends ScreenshotBoundaryException {
  const ScreenshotBoundaryNoImageException()
      : super("No image could be generated. If the Screenshot Boundary wraps Widgets with animations (e.g. Splash animations) trigger this function after all animations are done");
}
