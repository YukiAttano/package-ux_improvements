...
class AdaptiveRefreshIndicator
  ...
  final RefreshCallback
      onRefresh;
  final RefreshIndicatorConfiguration
      indicatorConfig;
  final CupertinoSliverRefreshControlConfiguration
      cupertinoConfig;
  final CustomScrollViewConfiguration
      config;
  ...
  AdaptiveRefreshIndicator.slivers({
    ...
    List<Widget> slivers =
        const [],
          ...
          adaptPhysics:
              adaptPhysics,
          customSliversBuilder: (cupertinoRefresh, padding) => _customSliversBuilder(
              cupertinoRefresh,
              padding,
              slivers),
        );
            ...
            sliver:
              ...
              sliver:
                ...
                refreshIndicatorExtent:
                    cupertinoConfig.refreshIndicatorExtent,
                builder:
                    cupertinoConfig.builder,
                onRefresh:
                    onRefresh,
              ),
            ),
