...
class _Settings extends StatelessWidget {
  ...
  const _Settings({super.key, this.selected, required this.onChangeIndicator});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        FilledButton.tonal(
          style: selected == null ? unselectedStyle : null,
          onPressed: () => onChangeIndicator(null),
          child: Text("Platform Default"),
        ),
        FilledButton.tonal(
          style: selected == true ? unselectedStyle : null,
          onPressed: () => onChangeIndicator(true),
          child: Text("Android"),
        ),
        FilledButton.tonal(
          style: selected == false ? unselectedStyle : null,
