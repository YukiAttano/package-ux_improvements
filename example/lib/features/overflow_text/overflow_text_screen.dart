...
class OverflowTextScreen
    extends StatelessWidget {
  const OverflowTextScreen(
      {super.key});
        ...
        return GestureDetector(
          ...
          child:
            ...
            children: [
              ...
              Visibility(
                visible:
                    !hasOverflow && widget.maxLines != null,
                child:
                    const Text(
